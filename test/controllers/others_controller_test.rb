...
class OthersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create other" do
    assert_difference("Other.count") do
      post others_url, params: { other: { content: @other.content, source: @other.source, timestamp: @other.timestamp, title: @other.title } }, as: :json
    end
  ...
  test "should update other" do
    patch other_url(@other), params: { other: { content: @other.content, source: @other.source, timestamp: @other.timestamp, title: @other.title } }, as: :json
    assert_response :success
  end
